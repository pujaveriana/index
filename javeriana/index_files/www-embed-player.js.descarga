...
;function I(a,b){this.b=0;this.m=void 0;this.h=this.f=this.g=null;this.i=this.j=!1;if(a!=pa)try{var c=this;a.call(b,function(a){xc(c,2,a)},function(a){xc(c,3,a)})}catch(d){xc(this,3,d)}}
function yc(){this.next=this.context=this.f=this.g=this.b=null;this.h=!1}
yc.prototype.reset=function(){this.context=this.f=this.g=this.b=null;this.h=!1};
...
function Fc(a,b){if(0==a.b)if(a.g){var c=a.g;if(c.f){for(var d=0,e=null,f=null,g=c.f;g&&(g.h||(d++,g.b==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.b&&1==d?Fc(c,b):(f?(d=f,d.next==c.h&&(c.h=d),d.next=d.next.next):Gc(c),Hc(c,e,3,b)))}a.g=null}else xc(a,3,b)}
function Ic(a,b){a.f||2!=a.b&&3!=a.b||Jc(a);a.h?a.h.next=b:a.f=b;a.h=b}
function Cc(a,b,c,d){var e=Ac(null,null,null);e.b=new I(function(a,g){e.g=b?function(c){try{var e=b.call(d,c);a(e)}catch(m){g(m)}}:a;
e.f=c?function(b){try{var e=c.call(d,b);!q(e)&&b instanceof Ec?g(b):a(e)}catch(m){g(m)}}:g});
e.b.g=a;Ic(a,e);return e.b}
I.prototype.w=function(a){this.b=0;xc(this,2,a)};
I.prototype.A=function(a){this.b=0;xc(this,3,a)};
function xc(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;a:{var d=c,e=a.w,f=a.A;if(d instanceof I){Ic(d,Ac(e||pa,f||null,a));var g=!0}else if(wc(d))d.then(e,f,a),g=!0;else{if(wa(d))try{var h=d.then;if(ua(h)){Kc(d,h,e,f,a);g=!0;break a}}catch(l){f.call(a,l);g=!0;break a}g=!1}}g||(a.m=c,a.b=b,a.g=null,Jc(a),3!=b||c instanceof Ec||Lc(a,c))}}
function Kc(a,b,c,d,e){function f(a){h||(h=!0,d.call(e,a))}
function g(a){h||(h=!0,c.call(e,a))}
var h=!1;try{b.call(a,g,f)}catch(l){f(l)}}
function Jc(a){a.j||(a.j=!0,Xb(a.o,a))}
function Gc(a){var b=null;a.f&&(b=a.f,a.f=b.next,b.next=null);a.f||(a.h=null);return b}
I.prototype.o=function(){for(var a;a=Gc(this);)Hc(this,a,this.b,this.m);this.j=!1};
function Hc(a,b,c,d){if(3==c&&b.f&&!b.h)for(;a&&a.i;a=a.g)a.i=!1;if(b.b)b.b.g=null,Mc(b,c,d);else try{b.h?b.g.call(b.context):Mc(b,c,d)}catch(e){Nc.call(null,e)}Qb(zc,b)}
function Mc(a,b,c){2==b?a.g.call(a.context,c):a.f&&a.f.call(a.context,c)}
function Lc(a,b){a.i=!0;Xb(function(){a.i&&Nc.call(null,b)})}
var Nc=Rb;function Ec(a){A.call(this,a)}
z(Ec,A);Ec.prototype.name="cancel";function J(a){H.call(this);this.j=1;this.h=[];this.i=0;this.b=[];this.g={};this.m=!!a}
...
function Oc(a,b,c,d){if(b=a.g[b]){var e=a.b;(b=Ga(b,function(a){return e[a+1]==c&&e[a+2]==d}))&&a.D(b)}}
...
Rc.prototype.f=function(a){a=Rc.u.get.call(this,a);if(!q(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
Rc.prototype.get=function(a){if(a=this.f(a)){if(a=a.data,!q(a))throw"Storage: Invalid value was encountered";}else a=void 0;return a};function K(a){this.b=a}
...
K.prototype.f=function(a,b){var c=K.u.f.call(this,a);if(c){var d;if(d=!b){d=c.creation;var e=c.expiration;d=!!e&&e<y()||!!d&&d>y()}if(d)K.prototype.remove.call(this,a);else return c}};function Uc(a){this.b=a}
z(Uc,K);function Vc(){}
;function Wc(){}
...
;function Ee(a,b,c,d,e){this.g=a;this.i=b;this.h=c;this.f=d;this.b=e}
...
;function Te(a,b,c,d,e){var f={};f.eventTimeMs=Math.round(d||M());f[a]=b;f.context={lastActivityMs:String(d?-1:De())};b="log_event";R("web_system_health_gel2")&&"systemHealthCaptured"==a&&(b="log_event2");Oe({endpoint:b,payload:f,Y:e},c)}
...
;function of(a){H.call(this);this.b=[];this.g=a||this}
n(of,H);function pf(a,b,c,d){d=md(v(d,a.g));d={target:b,name:c,ma:d};b.addEventListener(c,d.ma,void 0);a.b.push(d)}
...
;function og(a,b){H.call(this);this.o=this.j=a;this.O=b;this.A=!1;this.g={};this.U=this.N=null;this.J=new J;ec(this,x(fc,this.J));this.i={};this.G=this.V=this.h=this.da=this.b=null;this.R=!1;this.H=this.w=this.m=this.M=null;this.W={};this.ua=["onReady"];this.S=new of(this);ec(this,x(fc,this.S));this.ba=null;this.ka=NaN;this.T={};pg(this);this.C("onDetailedError",v(this.La,this));this.C("onTabOrderChange",v(this.wa,this));this.C("onTabAnnounce",v(this.la,this));this.C("WATCH_LATER_VIDEO_ADDED",v(this.Ma,
...
n(og,H);k=og.prototype;k.ja=function(a,b){this.f||(qg(this,a),rg(this,b),this.A&&sg(this))};
...
this.i[e]);sg(this);this.V&&this.V(this.g);this.J.K("onReady",this.g)}else this.ka=S(v(this.L,this),50)}};
...
k.C=function(a,b){if(!this.f){var c=tg(this,b);if(c){if(!(0<=B(this.ua,a)||this.i[a])){var d=Cg(this,a);this.N&&this.N(a,d)}this.J.subscribe(a,c);"onReady"==a&&this.A&&S(x(c,this.g),0)}}};
k.Sa=function(a,b){if(!this.f){var c=tg(this,b);c&&Oc(this.J,a,c)}};
...
function Cg(a,b){var c="ytPlayer"+b+a.O,d=v(function(a){if("html5"==yg(this)){var c=this.b&&this.b.args&&this.b.args.fflags;if(c&&0>c.indexOf("use_html5_player_event_timeout=true")){this.J.K(b,a);return}}var d=S(v(function(){if(!this.f){this.J.K(b,a);var c=this.T,e=String(d);e in c&&delete c[e]}},this),0);
...
k.l=function(){zg(this);if(this.m&&this.b&&this.m.destroy)try{this.m.destroy()}catch(b){Q(b)}this.W=null;for(var a in this.i)p[this.i[a]]=null;this.da=this.b=this.g=null;delete this.j;delete this.o;H.prototype.l.call(this)};
function Ag(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
var wg=["fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];var Dg={},Eg="player_uid_"+(1E9*Math.random()>>>0);function Fg(a){var b="player";b=r(b)?zb(b):b;a=mf(a);var c=Eg+"_"+(b[xa]||(b[xa]=++ya)),d=Dg[c];if(d)return d.ja(a),d.g;d=new og(b,c);Dg[c]=d;Ad("player-added",d.g);ec(d,x(Gg,d));S(function(){d.ja(a)},0);
return d.g}
...
;function Lg(a){H.call(this);this.g=a;this.g.subscribe("command",this.ra,this);this.h={};this.i=!1}
z(Lg,H);k=Lg.prototype;k.start=function(){this.i||this.f||(this.i=!0,Mg(this.g,"RECEIVING"))};
...
k.l=function(){var a=this.g;a.f||Oc(a.b,"command",this.ra,this);this.g=null;for(var b in this.h)Ng(this,b);Lg.u.l.call(this)};function Qg(a,b){Lg.call(this,b);this.b=a;this.start()}
...
Qg.prototype.l=function(){Qg.u.l.call(this);delete this.b};function Rg(a,b,c,d){H.call(this);this.g=b||null;this.o="*";this.h=c||null;this.sessionId=null;this.channel=d||null;this.A=!!a;this.m=v(this.w,this);window.addEventListener("message",this.m)}
n(Rg,H);Rg.prototype.w=function(a){if(!("*"!=this.h&&a.origin!=this.h||this.g&&a.source!=this.g)&&r(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.A&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.h=this.o=a.origin);this.g=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=B(this.j,b.func))&&this.i(b.func,b.args)}}};
Rg.prototype.sendMessage=function(a,b){var c=b||this.g;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=pc(a);c.postMessage(d,this.o)}catch(e){Q(e,"WARNING")}}};
...
n(Sg,Rg);function Tg(){var a=this.f=new Sg(!!O("WIDGET_ID_ENFORCE")),b=v(this.Ra,this);a.i=b;a.j=null;this.f.channel="widget";if(a=O("WIDGET_ID"))this.f.sessionId=a;this.h=[];this.j=!1;this.i={}}
...
k.dispose=function(){this.f=null};function Wg(a){Tg.call(this);this.b=a;this.g=[];this.addEventListener("onReady",v(this.Oa,this));this.addEventListener("onVideoProgress",v(this.Ya,this));this.addEventListener("onVolumeChange",v(this.Za,this));this.addEventListener("onApiChange",v(this.Ta,this));this.addEventListener("onPlaybackQualityChange",v(this.Va,this));this.addEventListener("onPlaybackRateChange",v(this.Wa,this));this.addEventListener("onStateChange",v(this.Xa,this))}
...
k.dispose=function(){Wg.u.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function Xg(){H.call(this);this.b=new J;ec(this,x(fc,this.b))}
z(Xg,H);Xg.prototype.subscribe=function(a,b,c){return this.f?0:this.b.subscribe(a,b,c)};
Xg.prototype.D=function(a){return this.f?!1:this.b.D(a)};
Xg.prototype.j=function(a,b){this.f||this.b.K.apply(this.b,arguments)};function Yg(a,b,c){Xg.call(this);this.g=a;this.h=b;this.i=c}
z(Yg,Xg);function Mg(a,b,c){if(!a.f){var d=a.g;d.f||a.h!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(pc(a),d.h))}}
Yg.prototype.l=function(){this.h=this.g=null;Yg.u.l.call(this)};function Zg(a,b,c){H.call(this);this.b=a;this.h=c;this.i=Ae(window,"message",v(this.j,this));this.g=new Yg(this,a,b);ec(this,x(fc,this.g))}
...
n(bh,A);function ch(a){this.g=void 0===a?null:a;this.f=0;this.b=null}
ch.prototype.then=function(a,b,c){return this.g?this.g.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),wc(a)?a:dh(a)):2===this.f&&b?(a=b.call(c,this.b),wc(a)?a:eh(a)):this};
ch.prototype.getValue=function(){return this.b};
vc(ch);function eh(a){var b=new ch;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function dh(a){var b=new ch;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
...
a.addEventListener("onLogVeClicked",Dh);a.addEventListener("onLogVesShown",Eh);a.addEventListener("onReady",Fh);b=O("POST_MESSAGE_ID","player");O("ENABLE_JS_API")?xh=new Wg(a):O("ENABLE_POST_API")&&r(b)&&r(c)&&(wh=new Zg(window.parent,b,c),xh=new Qg(a,wh.g));O("BG_P")&&(O("BG_I")||O("BG_IU"))&&Nd();te()},void 0);
